<div style="background-color: white; margin-top:25px; !important;" class="container">
    <div class="row">
        <div class="col-2 mt-5">
            <button style="font-size: 20px;" type="button" class="btn btn-secondary col-12 mt-2 mb-1">INDEX</button>
            <button style="height: 100px;" type="button" class="btn btn-secondary col-12 mt-2 mb-1">INDEX</button>
