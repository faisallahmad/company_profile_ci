<div class="container-fluid">
    <div class="row">
        <div class="col-2 mt-5">
            ...
            <button style="font-size: 20px;" type="button" class="btn btn-secondary col-12 mt-2 mb-1">Production</button>
            <button style="font-size: 20px;" type="button" class="btn btn-secondary col-12 mt-2 mb-1">Training</button>
            <button style="font-size: 20px;" type="button" class="btn btn-secondary col-12 mt-2 mb-1">Validation</button>
