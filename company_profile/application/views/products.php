<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-10">
            ...
            <h3 style="color: black;" class="display-6">TECHNICAL SPECIFICATION</h3>
                <div class="row">
                    <div class="col-2">
                        <p style="font-size: 20px;">Air Flow Rate</p>
                    </div>
                    <div class="col-4">
                        <p style="font-size: 20px;">: 1000 Cfm - 35.000 Cfm </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <p style="font-size: 20px;">Static Pressure</p>
                    </div>
                    <div class="col-4">
                        <p style="font-size: 20px;">: 2" H2O - 8" H2O</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <p style="font-size: 20px;">Cooling Capacity</p>
                    </div>
                    <div class="col-4">
                        <p style="font-size: 20px;">: 50.000 Btuh - 1.500.000 Btuh</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <p style="font-size: 20px;">Heating Capacity</p>
                    </div>
                    <div class="col-4">
                        <p style="font-size: 20px;">: 50.000 Btuh - 1.500.000 Btuh</p>
                    </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <p style="font-size: 20px;">Body's Material</p>
                    </div>
                    <div class="col-4">
                        <p style="font-size: 20px;">: Galvani Powder Coating / Stainless Steel 304</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                        <p style="font-size: 20px;">Motor's Spec</p>
                    </div>
                    <div class="col-4">
                        <p style="font-size: 20px;">: ATEX / Standard IP 55</p>
                    </div>
                </div>
            </div>
        </div>
